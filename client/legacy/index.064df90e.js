...
function create_if_block$1(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(p, file$c, 59, 6, 1367);
    },
    m: function mount(target, anchor) {
...
function create_fragment$c(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(p, file$c, 47, 4, 913);
      ...
      add_location(img2, file$c, 64, 4, 1460);
      attr_dev(div2, "class", "flex flex-col border justify-start border-gray-400 m-5 p-3 ");
...
function create_fragment$b(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(h41, file$b, 56, 8, 1933);
      attr_dev(button0, "class", "w-32 m-3 fushia-text border border-purple-400 border-solid");
      add_location(button0, file$b, 55, 6, 1808);
      add_location(h42, file$b, 59, 8, 2103);
      attr_dev(button1, "class", "w-32 m-3 fushia-text border border-purple-400 border-solid");
      add_location(button1, file$b, 58, 6, 1976);
      add_location(h43, file$b, 62, 8, 2270);
      attr_dev(button2, "class", "w-32\tm-3 fushia-text border border-purple-400 border-solid");
      add_location(button2, file$b, 61, 6, 2148);
      add_location(h44, file$b, 65, 8, 2431);
      attr_dev(button3, "class", "w-32\tm-3 fushia-text border border-purple-400 border-solid");
      add_location(button3, file$b, 64, 6, 2310);
      add_location(h45, file$b, 68, 8, 2592);
      attr_dev(button4, "class", "w-32\tm-3 fushia-text border border-purple-400 border-solid");
      add_location(button4, file$b, 67, 6, 2470);
      attr_dev(div3, "class", "flex justify-evenly flex-wrap");
      add_location(div3, file$b, 53, 4, 1755);
      attr_dev(div4, "class", "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-10");
      add_location(div4, file$b, 72, 4, 2647);
      attr_dev(article, "class", "container mx-auto ");
...
function create_fragment$8(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(img0, "class", "logo mt-5 mx-auto svelte-19ymy2v");
      ...
      add_location(img0, file$8, 27, 6, 374);
      attr_dev(small, "class", "text-xs mb-3");
      add_location(small, file$8, 30, 10, 577);
      ...
      add_location(img1, file$8, 32, 12, 658);
      ...
      add_location(img2, file$8, 33, 12, 809);
      add_location(div0, file$8, 31, 10, 639);
      attr_dev(div1, "class", "flex flex-col justify-center align-center");
      add_location(div1, file$8, 29, 8, 510);
      attr_dev(div2, "class", "mt-10 sm:mx-10");
      add_location(div2, file$8, 28, 6, 472);
      attr_dev(a0, "class", "hover:underline");
      attr_dev(a0, "href", "#home");
      add_location(a0, file$8, 38, 12, 1018);
      add_location(li0, file$8, 38, 8, 1014);
      attr_dev(a1, "class", "hover:underline");
      attr_dev(a1, "href", "#toda-la-data");
      add_location(a1, file$8, 39, 12, 1085);
      add_location(li1, file$8, 39, 8, 1081);
      attr_dev(a2, "class", "hover:underline");
      attr_dev(a2, "href", "#libro");
      add_location(a2, file$8, 40, 12, 1166);
      add_location(li2, file$8, 40, 8, 1162);
      attr_dev(a3, "class", "hover:underline");
      attr_dev(a3, "href", "#kit-de-herramientas");
      add_location(a3, file$8, 41, 12, 1235);
      add_location(li3, file$8, 41, 8, 1231);
      attr_dev(a4, "class", "hover:underline");
      attr_dev(a4, "href", "#sos-docente");
      add_location(a4, file$8, 42, 12, 1332);
      add_location(li4, file$8, 42, 8, 1328);
      attr_dev(a5, "class", "hover:underline");
      attr_dev(a5, "href", "#quienes-somos");
      add_location(a5, file$8, 43, 12, 1413);
      add_location(li5, file$8, 43, 8, 1409);
      attr_dev(ul, "class", "uppercase text-bold mt-5   text-center sm:text-left");
      add_location(ul, file$8, 37, 6, 940);
      ...
      attr_dev(a6, "target", "_blank");
      add_location(a6, file$8, 47, 4, 1623);
      attr_dev(p, "class", "text-center text-xs text-bold mt-10");
      add_location(p, file$8, 46, 2, 1511);
...
function create_fragment$7(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$7, 2, 2, 117);
      attr_dev(h20, "class", "rounded-sm  p-1 uppercase");
      add_location(h20, file$7, 5, 4, 262);
      attr_dev(div0, "class", "flex celeste-bg p-2 mb-5");
      add_location(div0, file$7, 4, 3, 218);
      attr_dev(h21, "class", "rounded-sm p-1 uppercase");
      add_location(h21, file$7, 10, 4, 458);
      attr_dev(div1, "class", "flex celeste-bg p-2 items-center");
      add_location(div1, file$7, 9, 3, 406);
      attr_dev(span0, "class", "uppercase font-normal");
      add_location(span0, file$7, 15, 4, 626);
      attr_dev(p, "class", "font-sans mt-6 mb-3 lowercase");
      add_location(p, file$7, 14, 3, 579);
      attr_dev(span1, "class", "fushia-bg py-2 px-5 border hover:border-gray-800 border-solid");
      add_location(span1, file$7, 18, 30, 972);
      attr_dev(a, "href", "/documents/Corazones-y-mentes.pdf");
      attr_dev(a, "download", "");
      attr_dev(a, "class", "py-3 float-right");
      add_location(a, file$7, 17, 3, 888);
      add_location(div2, file$7, 3, 2, 208);
      attr_dev(article, "class", "grid grid-cols-1 md:grid-cols-2 items-center ");
      add_location(article, file$7, 1, 1, 50);
      attr_dev(div3, "class", "container mx-auto py-24");
...
function create_fragment$5(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(img, "class", "w-70 sm:w-50 mx-auto mb-6");
      if (img.src !== (img_src_value = "sosdocente-hero.png")) attr_dev(img, "src", img_src_value);
      attr_dev(img, "alt", "Ícono de una persona");
      add_location(img, file$5, 2, 2, 132);
      attr_dev(h2, "class", "rounded-sm  p-1 uppercase");
      add_location(h2, file$5, 5, 4, 278);
      attr_dev(div0, "class", " celeste-bg p-2 mb-5");
      add_location(div0, file$5, 4, 3, 238);
      attr_dev(p, "class", "mb-3 font-sans");
      add_location(p, file$5, 10, 4, 386);
      add_location(h30, file$5, 12, 4, 609);
      attr_dev(h31, "class", "mb-3");
      add_location(h31, file$5, 13, 4, 646);
      attr_dev(span, "class", "fushia-bg py-2 px-5 border hover:border-gray-800 border-solid");
      add_location(span, file$5, 15, 30, 741);
      attr_dev(a, "href", "#sos-docente");
      attr_dev(a, "class", "py-3 float-right");
      add_location(a, file$5, 14, 4, 686);
      attr_dev(div1, "class", "p-3");
      add_location(div1, file$5, 9, 3, 363);
      add_location(div2, file$5, 3, 2, 228);
      attr_dev(article, "class", "grid grid-cols-1 lg:grid-cols-2 md:mx-6 lg:mx-0 items-center");
      add_location(article, file$5, 1, 1, 50);
      attr_dev(div3, "class", "container mx-auto py-24");
      attr_dev(div3, "id", "home");
