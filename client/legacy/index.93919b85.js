...
function create_fragment$7(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(section0, file$7, 21, 5, 866);
      ...
      add_location(script0, file$7, 23, 3, 906);
      add_location(section1, file$7, 28, 4, 1132);
      ...
      add_location(blockquote1, file$7, 25, 3, 973);
      script1.async = true;
      if (script1.src !== (script1_src_value = "https://www.tiktok.com/embed.js")) attr_dev(script1, "src", script1_src_value);
      add_location(script1, file$7, 31, 3, 1178);
      add_location(section2, file$7, 37, 5, 1411);
...
var documents = [{
  ...
  url: "https://drive.google.com/file/d/1Ev_SW6b_4AQb07d4RNWkxCYAsUJw_HRy/view?usp=sharing"
}, {
  title: "Sesgo de confirmación: cuestionemos nuestras opiniones.",
  url: "https://drive.google.com/file/d/1XPBRd1Xgv0pvs1SkCDVXTiNtCYe0SBOv/view?usp=sharing"
}, {
  title: "Disonancia cognitiva: nuestro grupo no siempre tiene razón.",
  url: "https://drive.google.com/file/d/1gDL4rnYwzbx9soJecJawSivLb4NirqAu/view?usp=sharing"
}, {
  title: "Sesgo de atribución: seamos conscientes de nuestros prejuicios.",
  url: "https://drive.google.com/file/d/1RDmWNHTAydEsOJIE1LdbEg_lr-aWLxUq/view?usp=sharing"
}, {
  title: "La nueva normalidad es la diversidad",
  url: "https://drive.google.com/file/d/1hgS9yvhlLzhlGODtcL1eMkI2nhu2lseg/view?usp=sharing"
}, {
  title: "La privacidad como valor",
  url: "https://drive.google.com/file/d/1pP79B4Tkq0E7egD_gG1GkI89xb3fIBTn/view?usp=sharing"
}, {
  title: "Polarización: No todo es una lucha entre el bien y el mal.",
  url: "https://drive.google.com/file/d/1ppTaKkK2Y6EZai4HdwiPFwkQQ2q_uR6r/view?usp=sharing"
}, {
  title: "Información y desinformación en redes: No todo lo que se viraliza es verdadero.",
  url: "https://drive.google.com/file/d/14tL5FN5pj7UZzwZFNF9GlO7vvXaPaiDt/view?usp=sharing"
}];
...
function create_fragment$5(ctx) {
  ...
  var block = {
    c: function create() {
      ...
      p = element("p");
      span3 = element("span");
      t7 = text("Creamos una serie de artículos para que podamos ");
      br0 = element("br");
    ...
    l: function claim(nodes) {
      ...
      t7 = claim_text(span3_nodes, "Creamos una serie de artículos para que podamos ");
    ...
    h: function hydrate() {
      ...
      add_location(br0, file$5, 17, 53, 716);
      add_location(br1, file$5, 18, 69, 790);
      attr_dev(span3, "class", "bg-white");
      add_location(span3, file$5, 16, 4, 639);
...
function create_fragment$4(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(div3, file$4, 9, 0, 382);
    },
    m: function mount(target, anchor) {
      insert_dev(target, div3, anchor);
      append_dev(div3, article);
