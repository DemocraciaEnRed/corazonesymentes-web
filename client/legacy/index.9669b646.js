...
function create_fragment$7(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(blockquote0, file$7, 17, 3, 703);
      script0.async = true;
      if (script0.src !== (script0_src_value = "https://www.tiktok.com/embed.js")) attr_dev(script0, "src", script0_src_value);
      add_location(script0, file$7, 23, 3, 901);
      add_location(section1, file$7, 28, 4, 1122);
      ...
      add_location(blockquote1, file$7, 25, 3, 968);
      script1.async = true;
      if (script1.src !== (script1_src_value = "https://www.tiktok.com/embed.js")) attr_dev(script1, "src", script1_src_value);
      add_location(script1, file$7, 31, 3, 1168);
      add_location(section2, file$7, 37, 5, 1395);
...
function create_fragment$5(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(img, file$5, 6, 2, 272);
      attr_dev(span0, "class", "text-black");
      add_location(span0, file$5, 10, 5, 460);
      attr_dev(span1, "class", "text-black");
      add_location(span1, file$5, 10, 46, 501);
      attr_dev(span2, "class", "text-white bg-purple-400 tracking-tighter");
      add_location(span2, file$5, 9, 4, 398);
      attr_dev(h3, "class", "text-3xl mt-10 uppercase");
      add_location(h3, file$5, 8, 3, 356);
      add_location(br0, file$5, 14, 51, 666);
      add_location(br1, file$5, 15, 57, 728);
      attr_dev(span3, "class", "bg-white");
      add_location(span3, file$5, 13, 4, 591);
      attr_dev(p, "class", "mt-5 text-xl");
      add_location(p, file$5, 12, 3, 562);
      add_location(div0, file$5, 7, 2, 347);
      attr_dev(div1, "class", "grid grid-cols-1 md:grid-cols-3 mt-10");
      add_location(div1, file$5, 20, 2, 805);
      attr_dev(article, "class", "container mx-auto");
      add_location(article, file$5, 5, 1, 234);
      attr_dev(div2, "class", "bg-blue-100 p-10 tech-back px-10");
...
function create_fragment$4(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(div2, file$4, 17, 4, 628);
      add_location(script, file$4, 17, 161, 785);
      attr_dev(a, "href", "http://google.com");
      attr_dev(a, "target", "_blank");
      attr_dev(a, "class", "bg-white uppercase mt-5 text-xl p-3 ");
      add_location(a, file$4, 19, 6, 1140);
      attr_dev(p1, "class", "text-center p-3");
      add_location(p1, file$4, 18, 4, 1106);
      attr_dev(article, "class", "container mx-auto");
      add_location(article, file$4, 2, 2, 49);
      attr_dev(div3, "class", "bg-black p-10");
      attr_dev(div3, "id", "foro-docente");
      add_location(div3, file$4, 1, 0, 1);
    },
    m: function mount(target, anchor) {
      insert_dev(target, div3, anchor);
      append_dev(div3, article);
...
var file$3 = "src/components/Kit.svelte"; // (51:2) {#if opened}
...
function create_if_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(p, file$3, 51, 4, 1150);
      ...
      add_location(img, file$3, 55, 6, 1253);
      attr_dev(a, "class", "download p-2");
      attr_dev(a, "href",
      /*url*/
      ctx[3]);
      add_location(a, file$3, 54, 4, 1211);
    },
    m: function mount(target, anchor) {
...
function create_fragment$3(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      /*type*/
      ctx[1]);
      add_location(img, file$3, 43, 4, 783);
      attr_dev(h5, "class", "text-xs uppercase font-bold");
      add_location(h5, file$3, 45, 6, 898);
      attr_dev(h3, "class", "uppercase font-bold text-md");
      add_location(h3, file$3, 46, 6, 956);
      attr_dev(div0, "class", "flex-grow text-left flex flex-col pb-1");
      add_location(div0, file$3, 44, 4, 839);
      attr_dev(span, "class", "text-right text-xl cursor-pointer p-1");
      add_location(span, file$3, 48, 4, 1024);
      attr_dev(div1, "class", "flex");
      add_location(div1, file$3, 42, 2, 760);
      attr_dev(div2, "class", "flex flex-col border-b border-black mt-5 mb-5 m-2");
      add_location(div2, file$3, 41, 0, 694);
    },
    m: function mount(target, anchor) {
      insert_dev(target, div2, anchor);
...
function create_fragment$1(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(img0, file$1, 15, 6, 232);
      attr_dev(small, "class", "text-xs");
      add_location(small, file$1, 17, 8, 364);
      ...
      add_location(img1, file$1, 18, 8, 421);
      attr_dev(div0, "class", "flex flex-col justify-center");
      add_location(div0, file$1, 16, 6, 313);
      attr_dev(a0, "href", "#home");
      add_location(a0, file$1, 21, 12, 613);
      add_location(li0, file$1, 21, 8, 609);
      attr_dev(a1, "href", "#todaladata");
      add_location(a1, file$1, 22, 12, 655);
      add_location(li1, file$1, 22, 8, 651);
      attr_dev(a2, "href", "#articulo");
      add_location(a2, file$1, 23, 12, 710);
      add_location(li2, file$1, 23, 8, 706);
      attr_dev(a3, "href", "#foro-docente");
      add_location(a3, file$1, 24, 12, 760);
      add_location(li3, file$1, 24, 8, 756);
      attr_dev(a4, "href", "#kit-de-herramientas");
      add_location(a4, file$1, 25, 12, 818);
      add_location(li4, file$1, 25, 8, 814);
      attr_dev(ul, "class", "uppercase text-bold");
      add_location(ul, file$1, 20, 6, 568);
      attr_dev(div1, "class", "flex justify-between align-center");
      add_location(div1, file$1, 14, 4, 178);
      attr_dev(p, "class", "text-center text-xs text-bold");
      add_location(p, file$1, 28, 4, 905);
      attr_dev(div2, "class", "container mx-auto fot svelte-17k7ix7");
      add_location(div2, file$1, 13, 2, 138);
